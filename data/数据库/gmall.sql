...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '活动表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `activity_rule`  (
  ...
  `operate_time` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '活动规则表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `activity_sku`  (
  ...
  `operate_time` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '活动商品关联表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `base_attr_info`  (
  ...
  `operate_time` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 114 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '属性表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of base_attr_info
-- ----------------------------
INSERT INTO `base_attr_info` VALUES (23, '运行内存', 61, 3, '2021-12-14 00:00:00', NULL);
...
CREATE TABLE `base_attr_value`  (
  ...
  `operate_time` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 218 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '属性值表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `base_category1`  (
  ...
  `operate_time` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '一级品类表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `base_category2`  (
  ...
  `operate_time` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 113 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '二级品类表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `base_category3`  (
  ...
  `operate_time` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1099 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '三级品类表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `base_sale_attr`  (
  ...
  `operate_time` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '基本销售属性表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `base_sale_attr` VALUES (5, '处理器或内存', '2021-12-14 00:00:00', NULL);
...
-- ----------------------------
INSERT INTO `base_trademark` VALUES (1, '红米', NULL, '2021-12-14 00:00:00', NULL);
...
INSERT INTO `base_trademark` VALUES (12, '华为', '/static/default.jpg', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_trademark` VALUES (13, 'H&U&W', '/static/default.jpg', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_trademark` VALUES (14, 'VIVO', '/static/default.jpg', '2021-12-14 00:00:00', NULL);
INSERT INTO `base_trademark` VALUES (15, 'OPPO', '/static/default.jpg', '2021-12-14 00:00:00', NULL);
...
CREATE TABLE `coupon_range`  (
  ...
  `operate_time` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '优惠券范围表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `coupon_use`  (
  ...
  `operate_time` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '优惠券领用表' ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
-- Table structure for entity_mapping
-- ----------------------------
DROP TABLE IF EXISTS `entity_mapping`;
CREATE TABLE `entity_mapping`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '主键',
  `entity_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '实体类型（spu_name,attr_name,attr_value）',
  `std_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '标准词',
  `synonym` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '同义词',
  `distance` double NULL DEFAULT NULL COMMENT '距离',
  `is_reviewed` int NULL DEFAULT NULL COMMENT '是否通过审核（1：审核通过，0：审核未通过）',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `unique_idx`(`std_name` ASC, `synonym` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of entity_mapping
-- ----------------------------
INSERT INTO `entity_mapping` VALUES (1, 'spu_name', '小米12S Ultra', '小米12S Ultra', 0, 1);
INSERT INTO `entity_mapping` VALUES (2, 'spu_name', 'Redmi 10X', 'Redmi 10X', 0, 1);
INSERT INTO `entity_mapping` VALUES (3, 'spu_name', 'Apple iPhone 12', 'Apple iPhone 12', 0, 1);
INSERT INTO `entity_mapping` VALUES (4, 'spu_name', '联想（Lenovo） 拯救者Y9000P 2022 16英寸游戏笔记本电脑', '联想（Lenovo） 拯救者Y9000P 2022 16英寸游戏笔记本电脑', 0, 1);
INSERT INTO `entity_mapping` VALUES (5, 'spu_name', 'TCL巨幕私人影院电视 4K超高清 AI智慧屏  液晶平板电视机', 'TCL巨幕私人影院电视 4K超高清 AI智慧屏  液晶平板电视机', 0, 1);
INSERT INTO `entity_mapping` VALUES (6, 'spu_name', '小米电视 内置小爱 智能网络液晶平板教育电视', '小米电视 内置小爱 智能网络液晶平板教育电视', 0, 1);
INSERT INTO `entity_mapping` VALUES (7, 'spu_name', '十月稻田 长粒香大米 东北大米 东北香米 5kg', '十月稻田 长粒香大米 东北大米 东北香米 5kg', 0, 1);
INSERT INTO `entity_mapping` VALUES (8, 'spu_name', '金沙河面条 原味银丝挂面 龙须面 方便速食拉面 清汤面 900g', '金沙河面条 原味银丝挂面 龙须面 方便速食拉面 清汤面 900g', 0, 1);
INSERT INTO `entity_mapping` VALUES (9, 'spu_name', '索芙特i-Softto 口红不掉色唇膏保湿滋润 璀璨金钻哑光唇膏 ', '索芙特i-Softto 口红不掉色唇膏保湿滋润 璀璨金钻哑光唇膏 ', 0, 1);
INSERT INTO `entity_mapping` VALUES (10, 'spu_name', 'CAREMiLLE珂曼奶油小方口红 雾面滋润保湿持久丝缎唇膏', 'CAREMiLLE珂曼奶油小方口红 雾面滋润保湿持久丝缎唇膏', 0, 1);
INSERT INTO `entity_mapping` VALUES (11, 'spu_name', '香奈儿（Chanel）女士香水5号香水 粉邂逅柔情淡香水EDT ', '香奈儿（Chanel）女士香水5号香水 粉邂逅柔情淡香水EDT ', 0, 1);
INSERT INTO `entity_mapping` VALUES (12, 'spu_name', '华为智慧屏 4K全面屏智能电视机', '华为智慧屏 4K全面屏智能电视机', 0, 1);
INSERT INTO `entity_mapping` VALUES (13, 'spu_name', 'HAWEIAI Book 2025英特尔14 Pro满血独显笔记本', 'HAWEIAI Book 2025英特尔14 Pro满血独显笔记本', 0, 1);
INSERT INTO `entity_mapping` VALUES (14, 'spu_name', '华为HUAWEI二手笔记本MateBook13触屏2K全面屏', '华为HUAWEI二手笔记本MateBook13触屏2K全面屏', 0, 1);
INSERT INTO `entity_mapping` VALUES (15, 'spu_name', 'H&U&W国行笔记本电脑轻薄本', 'H&U&W国行笔记本电脑轻薄本', 0, 1);
INSERT INTO `entity_mapping` VALUES (16, 'spu_name', 'vivo S20', 'vivo S20', 0, 1);
INSERT INTO `entity_mapping` VALUES (17, 'spu_name', 'REDMI Turbo4 Pro', 'REDMI Turbo4 Pro', 0, 1);
INSERT INTO `entity_mapping` VALUES (18, 'spu_name', '华为Mate 40 pro', '华为Mate 40 pro', 0, 1);
INSERT INTO `entity_mapping` VALUES (19, 'spu_name', 'Apple/苹果 iPhone 16 Pro', 'Apple/苹果 iPhone 16 Pro', 0, 1);
INSERT INTO `entity_mapping` VALUES (20, 'spu_name', 'OPPO Find X8', 'OPPO Find X8', 0, 1);
INSERT INTO `entity_mapping` VALUES (21, 'spu_name', '小米12S Ultra', '小米12s ultr', 0.33665862679481506, 1);
INSERT INTO `entity_mapping` VALUES (22, 'spu_name', '小米12S Ultra', 'xiaomi 12s ultra', 0.4070693254470825, 1);
INSERT INTO `entity_mapping` VALUES (23, 'spu_name', '小米12S Ultra', 'MI 12s ultr', 0.6911226511001587, 1);
...
CREATE TABLE `favor_info`  (
  ...
  `operate_time` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品收藏表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `order_detail_activity`  (
  ...
  `operate_time` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '订单明细活动关联表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `order_detail_coupon`  (
  ...
  `operate_time` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '订单明细优惠券关联表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `order_refund_info`  (
  ...
  `operate_time` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '退单表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `order_status_log`  (
  ...
  `operate_time` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '订单状态流水表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '退款支付表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `sku_attr_value`  (
  ...
  `operate_time` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 129 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'sku平台属性值关联表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `sku_image`  (
  ...
  `operate_time` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 245 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '库存单元图片表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sku_image` VALUES (197, 36, '1.jpg', '/data/images/36/1.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (198, 36, '2.jpg', '/data/images/36/2.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (199, 36, '3.jpg', '/data/images/36/3.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (200, 36, '4.jpg', '/data/images/36/4.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (201, 36, '5.jpg', '/data/images/36/5.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (202, 36, '6.jpg', '/data/images/36/6.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (203, 36, '7.jpg', '/data/images/36/7.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (204, 36, '8.jpg', '/data/images/36/8.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (205, 36, '9.jpg', '/data/images/36/9.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (206, 36, '10.jpg', '/data/images/36/10.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (207, 36, '11.jpg', '/data/images/36/11.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (208, 36, '12.jpg', '/data/images/36/12.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (209, 36, '13.jpg', '/data/images/36/13.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (210, 36, '14.jpg', '/data/images/36/14.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (211, 36, '15.jpg', '/data/images/36/15.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (212, 36, '16.jpg', '/data/images/36/16.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (213, 36, '17.jpg', '/data/images/36/17.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (214, 37, '1.jpg', '/data/images/37/1.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (215, 37, '2.jpg', '/data/images/37/2.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (216, 37, '3.jpg', '/data/images/37/3.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (217, 37, '4.jpg', '/data/images/37/4.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (218, 38, '1.jpg', '/data/images/38/1.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (219, 38, '2.jpg', '/data/images/38/2.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (220, 38, '3.jpg', '/data/images/38/3.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (221, 39, '1.jpg', '/data/images/39/1.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (222, 39, '2.jpg', '/data/images/39/2.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (223, 39, '3.jpg', '/data/images/39/3.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (224, 39, '4.jpg', '/data/images/39/4.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (225, 39, '5.jpg', '/data/images/39/5.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (226, 39, '6.jpg', '/data/images/39/6.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (227, 40, '1.jpg', '/data/images/40/1.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (228, 40, '2.jpg', '/data/images/40/2.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (229, 40, '3.jpg', '/data/images/40/3.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (230, 40, '4.jpg', '/data/images/40/4.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (231, 40, '5.jpg', '/data/images/40/5.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (232, 40, '6.jpg', '/data/images/40/6.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (233, 41, '1.jpg', '/data/images/41/1.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (234, 41, '2.jpg', '/data/images/41/2.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (235, 41, '3.jpg', '/data/images/41/3.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (236, 41, '4.jpg', '/data/images/41/4.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (237, 42, '1.jpg', '/data/images/42/1.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (238, 42, '2.jpg', '/data/images/42/2.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (239, 42, '3.jpg', '/data/images/42/3.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (240, 42, '4.jpg', '/data/images/42/4.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (241, 43, '1.jpg', '/data/images/43/1.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (242, 43, '2.jpg', '/data/images/43/2.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (243, 43, '3.jpg', '/data/images/43/3.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (244, 43, '4.jpg', '/data/images/43/4.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_image` VALUES (245, 43, '5.jpg', '/data/images/43/5.jpg', 89, '0', '2021-12-14 00:00:00', NULL);
...
CREATE TABLE `sku_info`  (
  ...
  `operate_time` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 44 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'sku表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sku_info
-- ----------------------------
INSERT INTO `sku_info` VALUES (1, 1, 6999, '小米12S Ultra 骁龙8+旗舰处理器 徕卡光学镜头 2K超视感屏 120Hz高刷 67W快充 8GB+128GB 冷杉绿 5G手机', '小米12S Ultra 骁龙8+旗舰处理器 徕卡光学镜头 2K超视感屏 120Hz高刷 67W快充 8GB+128GB 冷杉绿 5G手机', 1.00, 5, 61, 'http://47.93.148.192:8080/group1/M00/00/01/rBHu8l-rfvmAIpgZAAIvrX6L9fo612.jpg', 1, '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_info` VALUES (2, 1, 6999, '小米12S Ultra 骁龙8+旗舰处理器 徕卡光学镜头 2K超视感屏 120Hz高刷 67W快充 8GB+256GB 经典黑 5G手机', '小米12S Ultra 骁龙8+旗舰处理器 徕卡光学镜头 2K超视感屏 120Hz高刷 67W快充 8GB+256GB 经典黑 5G手机', 1.00, 5, 61, 'http://47.93.148.192:8080/group1/M00/00/01/rBHu8l-rfvmAcbl2AAFopp2WGBQ404.jpg', 0, '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_info` VALUES (3, 1, 6499, '小米12S Ultra 骁龙8+旗舰处理器 徕卡光学镜头 2K超视感屏 120Hz高刷 67W快充 8GB+128GB 经典黑 5G手机', '小米12S Ultra 骁龙8+旗舰处理器 徕卡光学镜头 2K超视感屏 120Hz高刷 67W快充 8GB+128GB 经典黑 5G手机', 1.00, 5, 61, 'http://47.93.148.192:8080/group1/M00/00/01/rBHu8l-rfvmAIpgZAAIvrX6L9fo612.jpg', 0, '2021-12-14 00:00:00', NULL);
...
INSERT INTO `sku_info` VALUES (8, 3, 8197, 'Apple iPhone 12 (A2404) 64GB 黑色 支持移动联通电信5G 双卡双待手机', 'Apple iPhone 12 (A2404) 64GB 黑色 支持移动联通电信5G 双卡双待手机', 1.00, 2, 61, 'http://47.93.148.192:8080/group1/M00/00/02/rBHu8l-rgfWAVRWzAABUiOmA0ic932.jpg', 1, '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_info` VALUES (9, 3, 8197, 'Apple iPhone 12 (A2404) 64GB 红色 支持移动联通电信5G 双卡双待手机', 'Apple iPhone 12 (A2404) 64GB 红色 支持移动联通电信5G 双卡双待手机', 1.00, 2, 61, 'http://47.93.148.192:8080/group1/M00/00/02/rBHu8l-rgfWAJllcAAEY0AkXL8M782.jpg', 1, '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_info` VALUES (10, 3, 8197, 'Apple iPhone 12 (A2404) 64GB 蓝色 支持移动联通电信5G 双卡双待手机', 'Apple iPhone 12 (A2404) 64GB 蓝色 支持移动联通电信5G 双卡双待手机', 1.00, 2, 61, 'http://47.93.148.192:8080/group1/M00/00/02/rBHu8l-rgfWAbqkuAAENKBtJukQ551.jpg', 1, '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_info` VALUES (11, 3, 8197, 'Apple iPhone 12 (A2404) 64GB 白色 支持移动联通电信5G 双卡双待手机', 'Apple iPhone 12 (A2404) 64GB 白色 支持移动联通电信5G 双卡双待手机', 1.00, 2, 61, 'http://47.93.148.192:8080/group1/M00/00/02/rBHu8l-rgfWASR1YAADsOUYB-2g312.jpg', 0, '2021-12-14 00:00:00', NULL);
...
INSERT INTO `sku_info` VALUES (34, 12, 3927, '华为智慧屏V55i-J 55英寸 HEGE-550B 4K全面屏智能电视机 多方视频通话 AI升降摄像头 银钻灰 京品家电', '华为智慧屏V55i-J 55英寸 HEGE-550B 4K全面屏智能电视机 多方视频通话 AI升降摄像头 银钻灰 京品家电', 30.00, 12, 86, 'http://47.93.148.192:8080/group1/M00/00/02/rBHu8l-02AyARcFFAAKGCeWL410100.jpg', 0, '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_info` VALUES (35, 12, 5499, '华为智慧屏V65i 65英寸 HEGE-560B 4K全面屏智能电视机 多方视频通话 AI升降摄像头 4GB+32GB 星际黑', '华为智慧屏V65i 65英寸 HEGE-560B 4K全面屏智能电视机 多方视频通话 AI升降摄像头 4GB+32GB 星际黑', 35.00, 12, 86, 'http://47.93.148.192:8080/group1/M00/00/02/rBHu8l-02AiAbf9pAAJ-rvQXZj4029.jpg', 0, '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_info` VALUES (36, 13, 3488, 'HAWEIAI Book【补贴30%】2025英特尔14 Pro满血独显笔记本电脑轻薄本高端高性能金属游戏设计大学生【2.5K全面屏+抗蓝光+指纹】 32G内存+2TB超速硬盘', 'HAWEIAI Book【补贴30%】2025英特尔14 Pro满血独显笔记本电脑轻薄本高端高性能金属游戏设计大学生【2.5K全面屏+抗蓝光+指纹】 32G内存+2TB超速硬盘', 35.00, 12, 285, 'http://47.93.148.192:8080/group1/M00/00/02/rBHu8l-02AiAbf9pAAJ-rvQXZj4029.jpg', 0, '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_info` VALUES (37, 14, 1229, '华为HUAWEI二手笔记本MateBook13触屏2K全面屏 便携二手笔记本电脑 Magic R5-2500-8G-256G-高分屏 95成新', '华为HUAWEI二手笔记本MateBook13触屏2K全面屏 便携二手笔记本电脑 Magic R5-2500-8G-256G-高分屏 95成新', 35.00, 12, 285, 'http://47.93.148.192:8080/group1/M00/00/02/rBHu8l-02AiAbf9pAAJ-rvQXZj4029.jpg', 0, '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_info` VALUES (38, 15, 955, 'H&U&W国行【2025新英特尔+酷睿i7】笔记本电脑轻薄本大学生办公便携高性能游戏本商务设计AI标压手提本 【15代14英寸】英特尔IPS护眼+9D蓝光全面屏 8G内存/128G超速硬盘', 'H&U&W国行【2025新英特尔+酷睿i7】笔记本电脑轻薄本大学生办公便携高性能游戏本商务设计AI标压手提本 【15代14英寸】英特尔IPS护眼+9D蓝光全面屏 8G内存/128G超速硬盘', 35.00, 13, 285, 'http://47.93.148.192:8080/group1/M00/00/02/rBHu8l-02AiAbf9pAAJ-rvQXZj4029.jpg', 0, '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_info` VALUES (39, 16, 1437, 'vivo S20 8GB+256GB 凤羽金 国家补贴 6500mAh超薄长续航 5000万防畸变柔光自拍 拍照 AI 手机 送礼', 'vivo S20 8GB+256GB 凤羽金 国家补贴 6500mAh超薄长续航 5000万防畸变柔光自拍 拍照 AI 手机 送礼', 35.00, 14, 61, 'http://47.93.148.192:8080/group1/M00/00/02/rBHu8l-02AiAbf9pAAJ-rvQXZj4029.jpg', 0, '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_info` VALUES (40, 17, 1436, '小米【国家补贴】REDMI Turbo4 Pro 新品上市 小米手机 小米5G手机红米turbo 7550mAh长续航电池 白色 12GB+256GB', '小米【国家补贴】REDMI Turbo4 Pro 新品上市 小米手机 小米5G手机红米turbo 7550mAh长续航电池 白色 12GB+256GB', 35.00, 1, 61, 'http://47.93.148.192:8080/group1/M00/00/02/rBHu8l-02AiAbf9pAAJ-rvQXZj4029.jpg', 0, '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_info` VALUES (41, 18, 1999, '华为Mate 40 pro 5G全网通麒麟9000芯片鸿蒙国货NFC双卡游戏学生 黑色 8+128 送适用100w充电器', '华为Mate 40 pro 5G全网通麒麟9000芯片鸿蒙国货NFC双卡游戏学生 黑色 8+128 送适用100w充电器', 35.00, 12, 61, 'http://47.93.148.192:8080/group1/M00/00/02/rBHu8l-02AiAbf9pAAJ-rvQXZj4029.jpg', 0, '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_info` VALUES (42, 19, 6961, 'Apple/苹果 iPhone 16 Pro（A3294）256GB 黑色钛金属 支持移动联通电信5G 双卡双待手机', 'Apple/苹果 iPhone 16 Pro（A3294）256GB 黑色钛金属 支持移动联通电信5G 双卡双待手机', 35.00, 2, 61, 'http://47.93.148.192:8080/group1/M00/00/02/rBHu8l-02AiAbf9pAAJ-rvQXZj4029.jpg', 0, '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_info` VALUES (43, 20, 2739, 'OPPO【分期免息】Find X8手机 全网通5G双卡双待 AI拍照新机 Find X8浮光白 12GB+256GB 简配+全国联保+版本咨询客服', 'OPPO【分期免息】Find X8手机 全网通5G双卡双待 AI拍照新机 Find X8浮光白 12GB+256GB 简配+全国联保+版本咨询客服', 35.00, 15, 61, 'http://47.93.148.192:8080/group1/M00/00/02/rBHu8l-02AiAbf9pAAJ-rvQXZj4029.jpg', 0, '2021-12-14 00:00:00', NULL);
...
CREATE TABLE `sku_sale_attr_value`  (
  ...
  `operate_time` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 51 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'sku销售属性值表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sku_sale_attr_value
-- ----------------------------
INSERT INTO `sku_sale_attr_value` VALUES (1, 1, 1, 1, 1, '颜色', '冷杉绿', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_sale_attr_value` VALUES (2, 1, 1, 4, 2, '版本', '8G+128G', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_sale_attr_value` VALUES (3, 2, 1, 2, 1, '颜色', '经典黑', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_sale_attr_value` VALUES (4, 2, 1, 4, 2, '版本', '8G+256G', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_sale_attr_value` VALUES (5, 3, 1, 2, 1, '颜色', '经典黑', '2021-12-14 00:00:00', NULL);
INSERT INTO `sku_sale_attr_value` VALUES (6, 3, 1, 3, 2, '版本', '8G+128G', '2021-12-14 00:00:00', NULL);
...
CREATE TABLE `spu_image`  (
  ...
  `operate_time` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 97 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'spu图片表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `spu_info`  (
  ...
  `operate_time` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 21 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'spu表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of spu_info
-- ----------------------------
INSERT INTO `spu_info` VALUES (1, '小米12S Ultra', '顶级拍照旗舰，影像效果超乎想象。', 61, 5, '2021-12-14 00:00:00', NULL);
INSERT INTO `spu_info` VALUES (2, 'Redmi 10X', '高性价比全能手机，续航持久不卡顿。', 61, 1, '2021-12-14 00:00:00', NULL);
INSERT INTO `spu_info` VALUES (3, 'Apple iPhone 12', '经典苹果体验，流畅手感一触即发。', 61, 2, '2021-12-14 00:00:00', NULL);
INSERT INTO `spu_info` VALUES (4, '联想（Lenovo） 拯救者Y9000P 2022 16英寸游戏笔记本电脑', '强悍性能，畅玩大型3A游戏无压力。', 287, 3, '2021-12-14 00:00:00', NULL);
INSERT INTO `spu_info` VALUES (5, 'TCL巨幕私人影院电视 4K超高清 AI智慧屏  液晶平板电视机', '超大屏4K影院体验，家庭观影首选。', 86, 4, '2021-12-14 00:00:00', NULL);
INSERT INTO `spu_info` VALUES (6, '小米电视 内置小爱 智能网络液晶平板教育电视', '智能语音控制，孩子学习与娱乐兼顾。', 86, 5, '2021-12-14 00:00:00', NULL);
INSERT INTO `spu_info` VALUES (7, '十月稻田 长粒香大米 东北大米 东北香米 5kg', '东北香米，粒粒饱满米香浓郁。', 803, 6, '2021-12-14 00:00:00', NULL);
INSERT INTO `spu_info` VALUES (8, '金沙河面条 原味银丝挂面 龙须面 方便速食拉面 清汤面 900g', '劲道爽滑，方便速食好选择。', 803, 7, '2021-12-14 00:00:00', NULL);
INSERT INTO `spu_info` VALUES (9, '索芙特i-Softto 口红不掉色唇膏保湿滋润 璀璨金钻哑光唇膏 ', '持久不脱色，唇色饱满动人。', 477, 8, '2021-12-14 00:00:00', NULL);
INSERT INTO `spu_info` VALUES (10, 'CAREMiLLE珂曼奶油小方口红 雾面滋润保湿持久丝缎唇膏', '丝缎雾面质感，滋润双唇长久绽放。', 477, 9, '2021-12-14 00:00:00', NULL);
INSERT INTO `spu_info` VALUES (11, '香奈儿（Chanel）女士香水5号香水 粉邂逅柔情淡香水EDT ', '经典香氛，柔情淡雅一喷迷人。', 473, 11, '2021-12-14 00:00:00', NULL);
INSERT INTO `spu_info` VALUES (12, '华为智慧屏 4K全面屏智能电视机', '轻薄高性能，办公娱乐全能本。', 86, 12, '2021-12-14 00:00:00', NULL);
INSERT INTO `spu_info` VALUES (13, 'HAWEIAI Book 2025英特尔14 Pro满血独显笔记本', '清晰画质，智能家庭娱乐新体验。', 285, 12, '2021-12-14 00:00:00', NULL);
INSERT INTO `spu_info` VALUES (14, '华为HUAWEI二手笔记本MateBook13触屏2K全面屏', '性价比高，2K触控屏办公顺畅。', 285, 12, '2021-12-14 00:00:00', NULL);
INSERT INTO `spu_info` VALUES (15, 'H&U&W国行笔记本电脑轻薄本', '便携办公利器，日常使用轻松无压力。', 285, 13, '2021-12-14 00:00:00', NULL);
INSERT INTO `spu_info` VALUES (16, 'vivo S20', '自拍旗舰，拍照清晰自然，颜值与性能兼顾。', 61, 14, '2021-12-14 00:00:00', NULL);
INSERT INTO `spu_info` VALUES (17, 'REDMI Turbo4 Pro', '充电快，游戏体验顺滑顺畅。', 61, 1, '2021-12-14 00:00:00', NULL);
INSERT INTO `spu_info` VALUES (18, '华为Mate 40 pro', '影像旗舰，拍照、性能全面领先。', 61, 12, '2021-12-14 00:00:00', NULL);
INSERT INTO `spu_info` VALUES (19, 'Apple iPhone 16 Pro', '全新旗舰，极致流畅与高效体验。', 61, 2, '2021-12-14 00:00:00', NULL);
INSERT INTO `spu_info` VALUES (20, 'OPPO Find X8', '超清屏幕与高颜值设计，手感舒适出众。', 61, 15, '2021-12-14 00:00:00', NULL);
...
CREATE TABLE `spu_poster`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品海报表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `spu_sale_attr`  (
  ...
  `operate_time` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'spu销售属性表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `spu_sale_attr_value`  (
  ...
  `operate_time` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 38 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'spu销售属性值表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `user_info`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 50 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户表' ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
-- Table structure for user_view_log
-- ----------------------------
...
CREATE TABLE `user_view_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 102 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户浏览日志表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of user_view_log
-- ----------------------------
INSERT INTO `user_view_log` VALUES (1, 41, 8, '2011-02-08 20:28:06');
INSERT INTO `user_view_log` VALUES (2, 48, 18, '2012-01-16 10:13:48');
INSERT INTO `user_view_log` VALUES (3, 15, 9, '2011-06-09 05:17:49');
INSERT INTO `user_view_log` VALUES (4, 44, 35, '2011-05-16 01:18:52');
INSERT INTO `user_view_log` VALUES (5, 38, 28, '2011-02-19 08:56:39');
INSERT INTO `user_view_log` VALUES (6, 2, 6, '2011-12-06 15:24:52');
INSERT INTO `user_view_log` VALUES (7, 15, 33, '2013-07-24 04:53:06');
INSERT INTO `user_view_log` VALUES (8, 2, 36, '2011-11-05 21:12:17');
INSERT INTO `user_view_log` VALUES (9, 46, 42, '2013-12-25 11:17:24');
INSERT INTO `user_view_log` VALUES (10, 35, 27, '2011-12-09 10:37:19');
INSERT INTO `user_view_log` VALUES (11, 29, 38, '2012-03-08 03:42:04');
INSERT INTO `user_view_log` VALUES (12, 1, 11, '2013-12-20 12:31:23');
INSERT INTO `user_view_log` VALUES (13, 28, 22, '2012-03-07 15:47:40');
INSERT INTO `user_view_log` VALUES (14, 10, 14, '2012-06-06 21:09:15');
INSERT INTO `user_view_log` VALUES (15, 7, 6, '2012-08-13 04:42:59');
INSERT INTO `user_view_log` VALUES (16, 7, 23, '2012-06-18 07:35:55');
INSERT INTO `user_view_log` VALUES (17, 39, 17, '2011-03-09 11:56:59');
INSERT INTO `user_view_log` VALUES (18, 47, 30, '2013-04-13 00:01:56');
INSERT INTO `user_view_log` VALUES (19, 8, 25, '2011-05-03 09:53:03');
INSERT INTO `user_view_log` VALUES (20, 36, 19, '2013-09-03 13:23:25');
INSERT INTO `user_view_log` VALUES (21, 40, 24, '2013-06-15 21:14:53');
INSERT INTO `user_view_log` VALUES (22, 13, 5, '2011-03-13 04:27:24');
INSERT INTO `user_view_log` VALUES (23, 43, 15, '2012-03-25 13:09:54');
INSERT INTO `user_view_log` VALUES (24, 6, 15, '2011-06-06 21:36:22');
INSERT INTO `user_view_log` VALUES (25, 25, 18, '2012-12-05 08:21:40');
INSERT INTO `user_view_log` VALUES (26, 41, 24, '2011-09-10 16:11:03');
INSERT INTO `user_view_log` VALUES (27, 24, 23, '2011-11-22 10:59:17');
INSERT INTO `user_view_log` VALUES (28, 43, 18, '2013-12-26 05:45:27');
INSERT INTO `user_view_log` VALUES (29, 44, 42, '2011-04-22 02:12:15');
INSERT INTO `user_view_log` VALUES (30, 26, 32, '2012-04-23 12:59:49');
INSERT INTO `user_view_log` VALUES (31, 5, 20, '2013-01-20 18:11:56');
INSERT INTO `user_view_log` VALUES (32, 33, 11, '2013-07-29 22:44:32');
INSERT INTO `user_view_log` VALUES (33, 14, 7, '2013-08-10 14:53:19');
INSERT INTO `user_view_log` VALUES (34, 18, 5, '2011-06-12 00:34:16');
INSERT INTO `user_view_log` VALUES (35, 4, 33, '2013-12-05 10:40:14');
INSERT INTO `user_view_log` VALUES (36, 17, 21, '2012-11-22 06:23:10');
INSERT INTO `user_view_log` VALUES (37, 6, 25, '2013-06-03 08:59:12');
INSERT INTO `user_view_log` VALUES (38, 39, 2, '2013-07-02 01:09:24');
INSERT INTO `user_view_log` VALUES (39, 15, 14, '2011-03-12 02:34:20');
INSERT INTO `user_view_log` VALUES (40, 19, 5, '2012-12-10 04:22:32');
INSERT INTO `user_view_log` VALUES (41, 6, 11, '2011-03-30 11:35:10');
INSERT INTO `user_view_log` VALUES (42, 28, 10, '2013-04-11 23:00:15');
INSERT INTO `user_view_log` VALUES (43, 11, 3, '2013-05-02 19:12:39');
INSERT INTO `user_view_log` VALUES (44, 12, 41, '2011-10-13 07:03:24');
INSERT INTO `user_view_log` VALUES (45, 9, 27, '2012-05-22 18:47:29');
INSERT INTO `user_view_log` VALUES (46, 40, 16, '2011-02-21 21:00:32');
INSERT INTO `user_view_log` VALUES (47, 3, 1, '2011-09-01 04:55:42');
INSERT INTO `user_view_log` VALUES (48, 23, 22, '2013-09-17 20:21:19');
INSERT INTO `user_view_log` VALUES (49, 4, 19, '2011-10-26 17:23:41');
INSERT INTO `user_view_log` VALUES (50, 5, 13, '2012-01-14 11:42:10');
INSERT INTO `user_view_log` VALUES (51, 13, 9, '2012-08-01 23:45:23');
INSERT INTO `user_view_log` VALUES (52, 36, 26, '2013-11-15 22:29:50');
INSERT INTO `user_view_log` VALUES (53, 32, 17, '2012-02-17 09:03:35');
INSERT INTO `user_view_log` VALUES (54, 49, 40, '2012-12-18 16:09:42');
INSERT INTO `user_view_log` VALUES (55, 10, 29, '2011-03-21 19:57:18');
INSERT INTO `user_view_log` VALUES (56, 37, 37, '2012-06-03 20:12:14');
INSERT INTO `user_view_log` VALUES (57, 3, 38, '2011-07-23 06:47:55');
INSERT INTO `user_view_log` VALUES (58, 45, 43, '2013-06-30 05:56:44');
INSERT INTO `user_view_log` VALUES (59, 27, 12, '2011-04-08 11:44:32');
INSERT INTO `user_view_log` VALUES (60, 13, 16, '2011-05-30 00:34:50');
INSERT INTO `user_view_log` VALUES (61, 30, 28, '2012-09-02 08:24:06');
INSERT INTO `user_view_log` VALUES (62, 33, 3, '2012-10-12 17:49:18');
INSERT INTO `user_view_log` VALUES (63, 50, 8, '2012-05-05 21:39:12');
INSERT INTO `user_view_log` VALUES (64, 24, 1, '2013-10-17 03:13:19');
INSERT INTO `user_view_log` VALUES (65, 20, 6, '2011-08-19 06:45:28');
INSERT INTO `user_view_log` VALUES (66, 30, 27, '2011-12-29 20:25:57');
INSERT INTO `user_view_log` VALUES (67, 11, 5, '2013-03-30 12:01:06');
INSERT INTO `user_view_log` VALUES (68, 18, 34, '2012-07-12 09:19:38');
INSERT INTO `user_view_log` VALUES (69, 7, 18, '2012-08-23 06:15:01');
INSERT INTO `user_view_log` VALUES (70, 21, 9, '2012-02-11 11:47:43');
INSERT INTO `user_view_log` VALUES (71, 46, 10, '2011-07-08 15:58:07');
INSERT INTO `user_view_log` VALUES (72, 19, 30, '2013-11-01 02:48:13');
INSERT INTO `user_view_log` VALUES (73, 31, 6, '2011-06-03 08:01:44');
INSERT INTO `user_view_log` VALUES (74, 14, 4, '2012-05-15 03:35:29');
INSERT INTO `user_view_log` VALUES (75, 22, 20, '2011-08-03 14:16:25');
INSERT INTO `user_view_log` VALUES (76, 49, 7, '2012-11-20 07:41:48');
INSERT INTO `user_view_log` VALUES (77, 34, 14, '2013-04-30 06:38:02');
INSERT INTO `user_view_log` VALUES (78, 21, 4, '2011-01-23 22:17:58');
INSERT INTO `user_view_log` VALUES (79, 38, 12, '2011-07-16 01:25:56');
INSERT INTO `user_view_log` VALUES (80, 16, 39, '2012-10-26 18:34:07');
INSERT INTO `user_view_log` VALUES (81, 17, 22, '2012-09-19 20:06:37');
INSERT INTO `user_view_log` VALUES (82, 31, 36, '2012-01-30 07:40:12');
INSERT INTO `user_view_log` VALUES (83, 25, 9, '2013-02-06 05:28:31');
INSERT INTO `user_view_log` VALUES (84, 26, 10, '2012-03-15 03:27:49');
INSERT INTO `user_view_log` VALUES (85, 22, 31, '2011-09-28 23:38:41');
INSERT INTO `user_view_log` VALUES (86, 9, 14, '2013-12-14 10:11:13');
INSERT INTO `user_view_log` VALUES (87, 42, 19, '2012-04-07 02:11:06');
INSERT INTO `user_view_log` VALUES (88, 12, 23, '2012-06-10 08:02:15');
INSERT INTO `user_view_log` VALUES (89, 8, 7, '2013-08-03 10:42:12');
INSERT INTO `user_view_log` VALUES (90, 45, 29, '2011-03-08 01:27:33');
INSERT INTO `user_view_log` VALUES (91, 37, 39, '2012-07-09 12:03:09');
INSERT INTO `user_view_log` VALUES (92, 27, 41, '2013-01-25 13:53:44');
INSERT INTO `user_view_log` VALUES (93, 5, 12, '2012-09-23 05:38:50');
INSERT INTO `user_view_log` VALUES (94, 32, 11, '2012-07-21 04:25:55');
INSERT INTO `user_view_log` VALUES (95, 20, 21, '2012-10-02 06:58:26');
INSERT INTO `user_view_log` VALUES (96, 16, 2, '2013-11-08 08:59:03');
INSERT INTO `user_view_log` VALUES (97, 23, 16, '2011-01-10 11:45:16');
INSERT INTO `user_view_log` VALUES (98, 34, 8, '2013-05-13 01:24:32');
INSERT INTO `user_view_log` VALUES (99, 29, 40, '2011-08-30 03:42:20');
INSERT INTO `user_view_log` VALUES (100, 35, 43, '2011-06-26 20:41:12');
INSERT INTO `user_view_log` VALUES (101, 48, 33, '2012-11-28 09:00:49');
INSERT INTO `user_view_log` VALUES (102, 50, 13, '2012-03-29 15:03:50');
